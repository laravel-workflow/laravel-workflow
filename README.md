# Laravel Workflow [![build](https://github.com/laravel-workflow/laravel-workflow/actions/workflows/php.yml/badge.svg?branch=master)](https://github.com/laravel-workflow/laravel-workflow/actions/workflows/php.yml) [![Scrutinizer Code Quality](https://scrutinizer-ci.com/g/laravel-workflow/laravel-workflow/badges/quality-score.png?b=master)](https://scrutinizer-ci.com/g/laravel-workflow/laravel-workflow/?branch=master) [![Code Coverage](https://scrutinizer-ci.com/g/laravel-workflow/laravel-workflow/badges/coverage.png?b=master)](https://scrutinizer-ci.com/g/laravel-workflow/laravel-workflow/?branch=master) [![Gitter](https://badges.gitter.im/laravel-workflow/community.svg)](https://gitter.im/laravel-workflow/community?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge)
...
You can use any queue driver that Laravel supports but this is heavily tested against Redis. Your cache driver must support locks. Also be sure to read the [docs](https://laravel-workflow.com/docs/installation#installing-laravel-workflow) too!
